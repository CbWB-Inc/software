...
p_task1_seg     equ 0x3800
p_task2_seg     equ 0x3c00
p_task3_seg     equ 0x4000
...
select_next_task:
    ...
    je .to_k_task
    cmp bx, ctx_p_task1
    je .to_k_task       ; ← ★追加！p_task1からはkに戻す
    cmp bx, ctx_p_task2
    je .to_k_task       ; ← ★追加！p_task2からはkに戻す
    cmp bx, ctx_p_task3
    je .to_k_task       ; ← ★追加！p_task3からはkに戻す
