...
;    out 0xA1, al
    ...
    mov dl, 0x80 ; Drive
    mov al, 0x04 ; Sectors To Read Count ;
    ...
    mov al, 0x04 ; Sectors To Read Count ;
    mov ch, 0x00 ; Cylinder
    mov cl, 0x25 ; Sector(starts from 1, not 0) ; set 2. becouse not need MBR
    mov dh, 0x00 ; Head
...
.alt_proc:
    ...
    mov byte [has_irq0_fired], 1

    cmp byte cs:[current_task], 0
    je .task4

.task3:
    mov byte cs:[current_task], 0
    ;jmp 0x400:0x0000

    call 0x400:0x0000
    ;call far [task3_entry2]
    jmp .after_func

.task4:

    mov byte cs:[current_task], 1
    ;jmp 0x480:0x0000

    call 0x480:0x0000
    ;call far [task4_entry2]
    jmp .after_func
