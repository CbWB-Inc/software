...
k_task_sector  equ 11       ; 子1はセクタ19から読み込む
d_task_sector  equ 28      ; 子2はセクタ14から読み込む
p_task1_sector  equ 37      ; 子3はセクタ18から読み込む
p_task2_sector  equ 46      ; 子3はセクタ22から読み込む
p_task3_sector  equ 55      ; 子3はセクタ26から読み込む
